...
var AngelOfflineModule = NativeModules5.AngelOfflineModule;
var AngelOfflineVideoModule = class {
  static startEventListeners() {
    const eventEmitter = new NativeEventEmitter(NativeModules5.ToastExample);
