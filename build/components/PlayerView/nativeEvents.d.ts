...
export type NativePlayerViewEvents = {
     ...
     */
    onBmpAdBreakFinished?: (event: {
        nativeEvent: AdBreakFinishedEvent;
    }) => void;
    /**
     * Event emitted when an ad break has started.
     */
    onBmpAdBreakStarted?: (event: {
        nativeEvent: AdBreakStartedEvent;
    }) => void;
    /**
     * Event emitted when an ad has been clicked.
     */
    onBmpAdClicked?: (event: {
        nativeEvent: AdClickedEvent;
    }) => void;
    /**
     * Event emitted when an ad error has occurred.
     */
    onBmpAdError?: (event: {
        nativeEvent: AdErrorEvent;
    }) => void;
    /**
     * Event emitted when an ad has finished.
     */
    onBmpAdFinished?: (event: {
        nativeEvent: AdFinishedEvent;
    }) => void;
    /**
     * Event emitted when an ad manifest starts loading.
     */
    onBmpAdManifestLoad?: (event: {
        nativeEvent: AdManifestLoadEvent;
    }) => void;
    /**
     ...
     */
    onBmpAdQuartile?: (event: {
        nativeEvent: AdQuartileEvent;
    }) => void;
    /**
     * Event emitted when an ad has been scheduled.
     */
    onBmpAdScheduled?: (event: {
        nativeEvent: AdScheduledEvent;
    }) => void;
    /**
     * Event emitted when an ad has been skipped.
     */
    onBmpAdSkipped?: (event: {
        nativeEvent: AdSkippedEvent;
    }) => void;
    /**
     * Event emitted when an ad has started.
     */
    onBmpAdStarted?: (event: {
        nativeEvent: AdStartedEvent;
    }) => void;
    /**
     ...
     */
    onBmpMuted?: (event: {
        nativeEvent: MutedEvent;
    }) => void;
    /**
     * Event emitted when the player has been paused.
     */
    onBmpPaused?: (event: {
        nativeEvent: PausedEvent;
    }) => void;
    /**
     ...
     */
    onBmpPlayerActive?: (event: {
        nativeEvent: PlayerActiveEvent;
    }) => void;
    /**
     * Event Emitted when a player error occurred.
     */
    onBmpPlayerError?: (event: {
        nativeEvent: PlayerErrorEvent;
    }) => void;
    /**
     * Event emitted when a player warning occurred.
     */
    onBmpPlayerWarning?: (event: {
        nativeEvent: PlayerWarningEvent;
    }) => void;
    /**
     * Emitted when playback has started.
     */
    onBmpPlaying?: (event: {
        nativeEvent: PlayingEvent;
    }) => void;
    /**
