...
extension RCTConvert {
    ...
    */
    static func networkConfig(_ json: Any?) -> NetworkConfig? {
        print("inside networkConfig -> RCTConvert+BitmovinPlayer")
        guard let json = json as? [String: Any?] else {
            return nil
        }
        let networkConfig = NetworkConfig()
        if let preprocessHttpRequestCallback = json["preprocessHttpRequestCallback"] as? String {
            class RequestDelegate: PreprocessHttpRequestDelegate {
